...
<cfset displayData = displayData.concat('<cfif FindNoCase("updated", attributes.message)>' & chr(13)) />
<cfset displayData = displayData.concat('	<cfset alert = "Your changes have been made." />' & chr(13)) />
<cfset displayData = displayData.concat('<cfelseif FindNoCase("added", attributes.message)>' & chr(13)) />
<cfset displayData = displayData.concat('	<cfset alert = "Your item has been added." />' & chr(13)) />
...
<cfset displayData = displayData.concat('<cfform action="#attributes.tableObj.getCFversionofTableName()#.cfm" method="post" class="editForm" enctype="multipart/form-data">' & chr(13)) />
